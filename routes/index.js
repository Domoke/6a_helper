  ...
  request.post({
    ...
    if (!error && response.statusCode == 200) {
      if(body.indexOf('var n=window.open') > -1) {
        ...
        async.eachSeries(products, function(prod, callback){
          ...
          res.render('index', { title: "A6助手",loginResult:"登录成功！", products: productList });
        });
      } else {
        console.log("登录失败!!!");
        res.render('index', { title: "A6助手",loginResult:"登录失败！！", products: productList });
      }
    } else {
      console.log(error);
      res.render('index', { title: "A6助手",loginResult:"服务异常！！！", products: productList });
    }
  });
